...
import com.ccfraser.muirwik.starterapp.meetingrooms.*
...
class MainFrame(props: MainFrameProps) : RComponent<MainFrameProps, MainFrameState>(props) {
    ...
    private val nameToTestMap = hashMapOf(
        "Moscow" to RBuilder::moscow,
        "NewYork" to RBuilder::newyork,
        "London" to RBuilder::london,
        "Alibaba" to RBuilder::alibaba,
        "Beijing" to RBuilder::beijing
    )
                ...
                styledDiv {
                    ...
                    mAppBar(position = MAppBarPosition.absolute) {
                        ...
                        mToolbar {
                            ...
                            mToolbarTitle("Check list meeting room - ${state.view}")
                    ...
                    mHidden(mdUp = true) {
                        mDrawer(state.responsiveDrawerOpen,
                            MDrawerAnchor.left,
